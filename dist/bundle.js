...
/***/ function(module, exports, __webpack_require__) {
	...
	var Battlefield_1 = __webpack_require__(4);
	...
	var controlled_entities = Immutable.List();
	document.getElementById('create_chracter').addEventListener('click', function (event) {
	    socket.emit('create_character');
	});
	socket.on('create_battlefield', function (characters) {
	    characters.forEach(function (character) {
	        var new_character = new Character_1.default(character.id, new Location_1.default(character.location.x, character.location.y));
	...
	socket.on('create_controlled_character', function (character) {
	    var new_entity = new Character_1.default(character.id, new Location_1.default(character.location.x, character.location.y));
	...
	document.addEventListener("keydown", function (event) {
	    ...
	    if (event.key === 'Tab') {
	        ...
	        if (controlled_entities.size > 1) {
	            var index = controlled_entities.findIndex(function (character_id) {
...
/***/ function(module, exports) {
	...
	var Character = (function () {
	    function Character(id, location) {
	        this.id = id;
	...
	var Battlefield = (function () {
	    ...
	    Battlefield.prototype.draw = function (selected_entity) {
	        ...
	        this.entities.forEach(function (entity) {
	            context.beginPath();
	            context.arc(entity.location.x * _this.grid.cell_size - _this.grid.cell_size / 2, entity.location.y * _this.grid.cell_size - _this.grid.cell_size / 2, _this.grid.cell_size / 2, 0, 2 * Math.PI, false);
	            context.closePath();
	    ...
	    Battlefield.prototype.updateCharacter = function (updated_character) {
	        var index = this.entities.findIndex(function (character) {
	            return updated_character.id === character.id;
	        });
	        this.entities = this.entities.set(index, updated_character);
	    };
	    Battlefield.prototype.getCharacter = function (id) {
